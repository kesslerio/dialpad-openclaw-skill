...
10. **Call transcripts:** `bin/get_call_transcript.py` is the supported transcript retrieval command for agents. It is transcript-only; AI recap, CRM enrichment, and follow-up drafting are intentionally separate work.
