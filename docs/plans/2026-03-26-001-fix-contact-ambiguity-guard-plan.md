...
- **Files:** `https://github.com/kesslerio/shapescale-openclaw-skills/blob/main/shapescale-crm/SKILL.md`, `https://github.com/kesslerio/shapescale-openclaw-skills/blob/main/shapescale-crm/references/company_workflows.md`, `https://github.com/kesslerio/shapescale-openclaw-skills/blob/main/shapescale-crm/references/deal_workflows.md`, `https://github.com/kesslerio/shapescale-openclaw-skills/blob/main/shapescale-crm/references/field_validation_guide.md`, `https://github.com/kesslerio/ShapeScaleAI/blob/main/claude-desktop-skills/build/attio-crm/SKILL.md`, `https://github.com/kesslerio/ShapeScaleAI/blob/main/claude-desktop-skills/build/attio-crm/references/field_validation_guide.md`.
...
- **Files:** `tests/test_sender_enrichment.py`, `tests/test_webhook_hooks.py`, `tests/test_webhook_server.py`, `https://github.com/kesslerio/shapescale-openclaw-skills/blob/main/shapescale-crm/tests/test_pipeline_hygiene.py`, `https://github.com/kesslerio/shapescale-openclaw-skills/blob/main/shapescale-crm/tests/test_pipeline_verify.py`.
