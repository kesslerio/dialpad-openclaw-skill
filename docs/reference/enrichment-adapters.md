...
Prior comms is deterministic by default: local SMS counts/link evidence and
Gmail message counts/dates only. It does not call a model, and it does not put raw
SMS or email bodies into customer-facing draft text.
